/*
  ...
  - The values [ASSINGED] on the enum `ClaimStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ClaimStatus_new" AS ENUM ('SUBMITTED', 'IN_REVIEW', 'ASSIGNED', 'APPROVED', 'REJECTED', 'COMPLETED', 'RESOLVED', 'RESOLVED_IN_COURT');
